...
export default function NavHoverLink({
  href,
  isActive,
  children,
}: NavHoverLinkProps) {
    ...
    >
      ...
      {isHovered && (
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(0, 136, 255, 0.15), rgba(255, 255, 255, 0.05))",
            boxShadow: `
      ...
      <Link
        href={href}
        className={`relative z-10 block py-1 px-2 text-sm transition-colors duration-200 cursor-none ${
          isActive
